...
// Copyright (c) 2014 The Earthdollar Developers
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Maplecoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  maplecoind [options]                     " + "\n" +
                  "  maplecoind [options] <command> [params]  " + _("Send command to -server or earthdollard") + "\n" +
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 10375 or testnet: 9375)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 10372 or testnet: 9372)") + "\n" +
